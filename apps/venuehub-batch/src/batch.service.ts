...
import { Member } from "apps/venuehub-api/src/libs/dto/member/member";
import { Property } from "apps/venuehub-api/src/libs/dto/property/property";
import {
  MemberStatus,
  MemberType,
} from "apps/venuehub-api/src/libs/enums/member.enum";
import { PropertyStatus } from "apps/venuehub-api/src/libs/enums/property.enum";
import { Model } from "mongoose";

@Injectable()
export class VenueHubBatchService {
  constructor(
